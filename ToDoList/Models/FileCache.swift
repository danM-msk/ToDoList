...
class FileCache {
    ...
    private var cache = [
        ...
        """, priority: .important, deadline: Date().addWeek(1)),
        ToDoItem(text: "asqwqewqwe", priority: .important, deadline: nil),
        ToDoItem(text: "3 task qewqwe", priority: .normal, deadline: nil)
    ]
